...
---
In this docuemnt I have summeraized all the steps taken to setup the Google Cloud Platform Compute Engine and the other necessary comuptational resources including GPU, and storage and the like.
...
Part Two
Instal Pyton and necessary enviroenmtns in VM
